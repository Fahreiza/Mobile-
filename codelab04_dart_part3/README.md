...
- list[0] = "2341720207"; → Populates the element at index 0.
- Now list = ["2341720207", null, null, null, null]
- list[1] = "Fahreiza Taura"; → Fills in the element at index 1.
- Now list = ["2341720207", "Fahreiza Taura", null, null, null]
...
- names1.add("Fahreiza Taura, 2341720207");
- Fill names1 now: {"Fahreiza Taura, 2341720207"}
- .addAll() → adds many elements at once to the Set (from another list/Set).
- names2.addAll({"2341720207"});
- Fill names2 now: {"2341720207"}
...
- main calls greet("Fahreiza") → output: Hello, Fahreiza!.
...
- Output:
- greet("Fahreiza") → Hello Fahreiza
- sapa("Fahreiza", "Morning") → Hello Fahreiza Morning.

c. Named Parameter { }
- The name parameter is marked required → mandatory.
- time has default value = "Noon".
- Output:
- greet(name: "Fahreiza", time: "Evening") → Hello Fahreiza, Good Evening.
